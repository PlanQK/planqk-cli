...
export class ServicePlatformServicesApi {
     ...
     * @param xOrganizationId The ID of your organization in case you want to perform operations in this context. Leave it empty to operate in your personal space.
     */
    public async getServices (lifecycle?: 'ERROR' | 'CREATING' | 'CREATED' | 'ACCESSIBLE' | 'PUBLISHED', xOrganizationId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<ServiceOverviewDto>;  }> {
        ...
        if (lifecycle !== undefined) {
            localVarQueryParameters['lifecycle'] = ObjectSerializer.serialize(lifecycle, "'ERROR' | 'CREATING' | 'CREATED' | 'ACCESSIBLE' | 'PUBLISHED'");
        }
