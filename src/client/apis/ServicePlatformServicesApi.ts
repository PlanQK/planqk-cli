...
import {
    BuildJobDtoFromJSON,
    BuildJobDtoToJSON,
    CreateExternalServicePricingPlanRequestFromJSON,
    CreateExternalServicePricingPlanRequestToJSON,
    CreateManagedServicePricingPlanRequestFromJSON,
    CreateManagedServicePricingPlanRequestToJSON,
    CreateWorkflowServiceRequestFromJSON,
    CreateWorkflowServiceRequestToJSON,
    PricingPlanDtoFromJSON,
    PricingPlanDtoToJSON,
    ProductUsageDtoFromJSON,
    ProductUsageDtoToJSON,
    RuntimeConfigurationFromJSON,
    RuntimeConfigurationToJSON,
    ServiceDefinitionCommandFromJSON,
    ServiceDefinitionCommandToJSON,
    ServiceDefinitionDtoFromJSON,
    ServiceDefinitionDtoToJSON,
    ServiceDtoFromJSON,
    ServiceDtoToJSON,
    ServiceExecutionDtoFromJSON,
    ServiceExecutionDtoToJSON,
    ServiceOverviewDtoFromJSON,
    ServiceOverviewDtoToJSON,
...
export interface CreateWorkflowServiceOperationRequest {
    createWorkflowServiceRequest: CreateWorkflowServiceRequest;
    xOrganizationId?: string;
}
...
export interface GetWorkflowModelRequest {
    serviceId: string;
    versionId: string;
    xOrganizationId?: string;
}
...
export interface UpdateApiSpecificationRequest {
    serviceId: string;
    versionId: string;
    file: Blob;
    xOrganizationId?: string;
...
export interface UpdateSourceCodePostRequest {
    serviceId: string;
    versionId: string;
    file: Blob;
    xOrganizationId?: string;
...
export interface UpdateSourceCodePutRequest {
    serviceId: string;
    versionId: string;
    sourceCode: Blob;
    xOrganizationId?: string;
...
export class ServicePlatformServicesApi extends runtime.BaseAPI {
    ...
    /**
     * Creates a new workflow service within your organization or for yourself, which allows you to orchestrate the execution of multiple existing services on PlanQK.
     */
    async createWorkflowServiceRaw(requestParameters: CreateWorkflowServiceOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ServiceDto>> {
        if (requestParameters.createWorkflowServiceRequest === null || requestParameters.createWorkflowServiceRequest === undefined) {
            throw new runtime.RequiredError('createWorkflowServiceRequest','Required parameter requestParameters.createWorkflowServiceRequest was null or undefined when calling createWorkflowService.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateWorkflowServiceRequestToJSON(requestParameters.createWorkflowServiceRequest),
        }, initOverrides);
     ...
     * Creates a new workflow service within your organization or for yourself, which allows you to orchestrate the execution of multiple existing services on PlanQK.
     */
    async createWorkflowService(requestParameters: CreateWorkflowServiceOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ServiceDto> {
        const response = await this.createWorkflowServiceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getServiceVersionsRaw(requestParameters: GetServiceVersionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ServiceDefinitionDto>>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(ServiceDefinitionDtoFromJSON));
    }

    /**
     * Gets a list of all service versions. Note: At the moment, there is only one service version per service.
     */
    async getServiceVersions(requestParameters: GetServiceVersionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<ServiceDefinitionDto>> {
    ...
    /**
     * Returns the workflow model of a workflow service, a BPMN 2.0 file that orchestrates the execution of multiple existing services on PlanQK.
     */
    async getWorkflowModelRaw(requestParameters: GetWorkflowModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.serviceId === null || requestParameters.serviceId === undefined) {
            throw new runtime.RequiredError('serviceId','Required parameter requestParameters.serviceId was null or undefined when calling getWorkflowModel.');
        }

        if (requestParameters.versionId === null || requestParameters.versionId === undefined) {
            throw new runtime.RequiredError('versionId','Required parameter requestParameters.versionId was null or undefined when calling getWorkflowModel.');
        }
        ...
        const response = await this.request({
            path: `/workflow-services/{serviceId}/versions/{versionId}/workflow-model`.replace(`{${"serviceId"}}`, encodeURIComponent(String(requestParameters.serviceId))).replace(`{${"versionId"}}`, encodeURIComponent(String(requestParameters.versionId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Returns the workflow model of a workflow service, a BPMN 2.0 file that orchestrates the execution of multiple existing services on PlanQK.
     */
    async getWorkflowModel(requestParameters: GetWorkflowModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.getWorkflowModelRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async updateApiDefinitionRaw(requestParameters: UpdateApiDefinitionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/v3/services/{serviceId}/versions/{versionId}/api-spec`.replace(`{${"serviceId"}}`, encodeURIComponent(String(requestParameters.serviceId))).replace(`{${"versionId"}}`, encodeURIComponent(String(requestParameters.versionId))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: formParams,
    ...
    /**
     * Upload an OpenAPI (formerly Swagger) compliant API specification describing the REST API of your service.
     */
    async updateApiSpecificationRaw(requestParameters: UpdateApiSpecificationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.serviceId === null || requestParameters.serviceId === undefined) {
            throw new runtime.RequiredError('serviceId','Required parameter requestParameters.serviceId was null or undefined when calling updateApiSpecification.');
        }

        if (requestParameters.versionId === null || requestParameters.versionId === undefined) {
            throw new runtime.RequiredError('versionId','Required parameter requestParameters.versionId was null or undefined when calling updateApiSpecification.');
        }

        if (requestParameters.file === null || requestParameters.file === undefined) {
            throw new runtime.RequiredError('file','Required parameter requestParameters.file was null or undefined when calling updateApiSpecification.');
        }
     ...
     * Upload an OpenAPI (formerly Swagger) compliant API specification describing the REST API of your service.
     */
    async updateApiSpecification(requestParameters: UpdateApiSpecificationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.updateApiSpecificationRaw(requestParameters, initOverrides);
    }
    ...
    /**
     * Updates the runtime configuration, including environment variables, of a managed service.
     */
    async updateRuntimeConfigurationRaw(requestParameters: UpdateRuntimeConfigurationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.serviceId === null || requestParameters.serviceId === undefined) {
            throw new runtime.RequiredError('serviceId','Required parameter requestParameters.serviceId was null or undefined when calling updateRuntimeConfiguration.');
        }

        if (requestParameters.versionId === null || requestParameters.versionId === undefined) {
            throw new runtime.RequiredError('versionId','Required parameter requestParameters.versionId was null or undefined when calling updateRuntimeConfiguration.');
        }

        if (requestParameters.runtimeConfiguration === null || requestParameters.runtimeConfiguration === undefined) {
            throw new runtime.RequiredError('runtimeConfiguration','Required parameter requestParameters.runtimeConfiguration was null or undefined when calling updateRuntimeConfiguration.');
        }
        ...
        const response = await this.request({
            path: `/services/{serviceId}/versions/{versionId}/runtime-configuration`.replace(`{${"serviceId"}}`, encodeURIComponent(String(requestParameters.serviceId))).replace(`{${"versionId"}}`, encodeURIComponent(String(requestParameters.versionId))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: RuntimeConfigurationToJSON(requestParameters.runtimeConfiguration),
        }, initOverrides);
     ...
     * Updates the runtime configuration, including environment variables, of a managed service.
     */
    async updateRuntimeConfiguration(requestParameters: UpdateRuntimeConfigurationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.updateRuntimeConfigurationRaw(requestParameters, initOverrides);
    }
     ...
     */
    async updateSourceCodePostRaw(requestParameters: UpdateSourceCodePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ServiceDefinitionDto>> {
        if (requestParameters.serviceId === null || requestParameters.serviceId === undefined) {
            throw new runtime.RequiredError('serviceId','Required parameter requestParameters.serviceId was null or undefined when calling updateSourceCodePost.');
        }

        if (requestParameters.versionId === null || requestParameters.versionId === undefined) {
            throw new runtime.RequiredError('versionId','Required parameter requestParameters.versionId was null or undefined when calling updateSourceCodePost.');
        }

        if (requestParameters.file === null || requestParameters.file === undefined) {
            throw new runtime.RequiredError('file','Required parameter requestParameters.file was null or undefined when calling updateSourceCodePost.');
        }
        ...
        const response = await this.request({
            path: `/v3/services/{serviceId}/versions/{versionId}/source-code`.replace(`{${"serviceId"}}`, encodeURIComponent(String(requestParameters.serviceId))).replace(`{${"versionId"}}`, encodeURIComponent(String(requestParameters.versionId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: formParams,
     ...
     * Updates the source code of a managed service and triggers a new build.
     */
    async updateSourceCodePost(requestParameters: UpdateSourceCodePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ServiceDefinitionDto> {
        const response = await this.updateSourceCodePostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Updates the source code of a managed service and triggers a new build.
     */
    async updateSourceCodePutRaw(requestParameters: UpdateSourceCodePutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ServiceDefinitionDto>> {
        if (requestParameters.serviceId === null || requestParameters.serviceId === undefined) {
            throw new runtime.RequiredError('serviceId','Required parameter requestParameters.serviceId was null or undefined when calling updateSourceCodePut.');
        }

        if (requestParameters.versionId === null || requestParameters.versionId === undefined) {
            throw new runtime.RequiredError('versionId','Required parameter requestParameters.versionId was null or undefined when calling updateSourceCodePut.');
        }

        if (requestParameters.sourceCode === null || requestParameters.sourceCode === undefined) {
            throw new runtime.RequiredError('sourceCode','Required parameter requestParameters.sourceCode was null or undefined when calling updateSourceCodePut.');
        }
     ...
     * Updates the source code of a managed service and triggers a new build.
     */
    async updateSourceCodePut(requestParameters: UpdateSourceCodePutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ServiceDefinitionDto> {
        const response = await this.updateSourceCodePutRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Updates the workflow model of a workflow service. The workflow model is a BPMN 2.0 file that describes the workflow of the service. The workflow model is used to orchestrate the execution of multiple existing services on PlanQK.
     */
    async updateWorkflowModelRaw(requestParameters: UpdateWorkflowModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.serviceId === null || requestParameters.serviceId === undefined) {
            throw new runtime.RequiredError('serviceId','Required parameter requestParameters.serviceId was null or undefined when calling updateWorkflowModel.');
        }

        if (requestParameters.versionId === null || requestParameters.versionId === undefined) {
            throw new runtime.RequiredError('versionId','Required parameter requestParameters.versionId was null or undefined when calling updateWorkflowModel.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling updateWorkflowModel.');
        }
     ...
     * Updates the workflow model of a workflow service. The workflow model is a BPMN 2.0 file that describes the workflow of the service. The workflow model is used to orchestrate the execution of multiple existing services on PlanQK.
     */
    async updateWorkflowModel(requestParameters: UpdateWorkflowModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.updateWorkflowModelRaw(requestParameters, initOverrides);
    }
