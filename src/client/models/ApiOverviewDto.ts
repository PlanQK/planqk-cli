...
export interface ApiOverviewDto {
     ...
     * @memberof ApiOverviewDto
     */
    quantumBackend?: ApiOverviewDtoQuantumBackendEnum;
    /**
     *
     * @type {string}
     * @memberof ApiOverviewDto
 ...
 * @export
 */
export const ApiOverviewDtoQuantumBackendEnum = {
    Ibm: 'IBM',
    Ionq: 'IONQ',
    Dwave: 'DWAVE',
    None: 'NONE'
} as const;
export type ApiOverviewDtoQuantumBackendEnum = typeof ApiOverviewDtoQuantumBackendEnum[keyof typeof ApiOverviewDtoQuantumBackendEnum];
