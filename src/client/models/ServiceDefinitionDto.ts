...
export interface ServiceDefinitionDto {
     ...
     * @memberof ServiceDefinitionDto
     */
    quantumBackend?: ServiceDefinitionDtoQuantumBackendEnum;
    /**
     *
     * @type {string}
     * @memberof ServiceDefinitionDto
 ...
 * @export
 */
export const ServiceDefinitionDtoQuantumBackendEnum = {
    Ibm: 'IBM',
    Ionq: 'IONQ',
    Dwave: 'DWAVE',
    None: 'NONE'
} as const;
export type ServiceDefinitionDtoQuantumBackendEnum = typeof ServiceDefinitionDtoQuantumBackendEnum[keyof typeof ServiceDefinitionDtoQuantumBackendEnum];
