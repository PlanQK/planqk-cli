...
export class ServiceDefinitionDtoConfigurationsInner {
    'type'?: string;
    'amount'?: number;
    'accelerator'?: ServiceDefinitionDtoConfigurationsInner.AcceleratorEnum;
    'unit'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ServiceDefinitionDtoConfigurationsInner.AcceleratorEnum"
        },
        {
            "name": "unit",
            "baseName": "unit",
    ...
    static getAttributeTypeMap() {
        return ServiceDefinitionDtoConfigurationsInner.attributeTypeMap;
    }
}

export namespace ServiceDefinitionDtoConfigurationsInner {
