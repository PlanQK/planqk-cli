...
export class PlatformManagedConfiguration extends ResourceConfiguration {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PlatformManagedConfiguration.attributeTypeMap);
    }
}
